...
def home(request):
    ...
    return render(request, 'mydam/home.html', {'total_contrib_usd': total_contrib_usd, 'total_contrib_afg': total_contrib_afg, 'user_count':user_count})
...
#             template = get_template('mydam/thank_you_email.html')
...
#     return render(request, 'mydam/register_donor.html', {'form':form})



# def thank_you(request):
#     return render(request, 'mydam/thank_you.html')
...
def register_donor(request):
    ...
    return render(request, 'mydam/register_donor.html', {'form': form, 'error_message': error_message})
